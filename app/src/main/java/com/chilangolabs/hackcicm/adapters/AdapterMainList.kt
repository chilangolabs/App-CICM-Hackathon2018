 ...
 * @since 04/03/18.
 */
class AdapterMainList(val data: List<ItemMain>, private val listener: OnRCListener) : RecyclerView.Adapter<AdapterMainList.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.itemView?.setOnClickListener {
            listener.onClick(position, holder.itemView.txtItemMainTitle)
        }
    }
